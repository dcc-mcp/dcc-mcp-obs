...
The legacy self-contained PyOxidizer source is retained only for historical
compatibility. It is no longer built or published by CI, and it is not a
fallback for a failed handshake.
